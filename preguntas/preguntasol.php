                  ...
                  <div class="card-body">
                    ...
                    <form action="resumencaso.php" method="POST">
                      <div class="form-check">
                        <input type="hidden" name="respuesta1" value="Solicitud de prepago">
                        <input class="form-check-input" type="radio" name="respuesta2" id="exampleRadios1" value="Aceleración de deuda total">
                        <label class="form-check-label" for="exampleRadios1">
                        Aceleración de deuda total
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="respuesta2" id="exampleRadios2" value="Aceleración de una o más compras">
